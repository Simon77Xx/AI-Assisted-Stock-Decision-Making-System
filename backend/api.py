...
# ── Proxy configuration ─────────────────────────────────────────────────
# User is outside China — ALL traffic (akshare stock data + AI API calls)
# needs the system proxy to reach Chinese financial data sources.
_PROXY = os.environ.get("HTTP_PROXY") or os.environ.get("HTTPS_PROXY") or "http://127.0.0.1:7890"
